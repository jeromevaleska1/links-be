...
export class LinksController {
    ...
    @ApiCreatedResponse({ description: 'Returns shortened url', type: GetLinkResponseDto })
    ...
    @ApiCreatedResponse({ description: 'User related statistics', type: GetUserDataResponseDto })
    @Get('user')
